...
from module.camera_frame_reader import USBCameraFrameReader
...
class USBVideoWindow(ImageWindow):
    ...
    def __init__(self, parent:QWidget=None):
        super(USBVideoWindow, self).__init__(parent)

        # UI
        self.ui:Any = Ui_USBVideoWindow()
        ...
        self.camera_reader:Union[USBCameraFrameReader, None] = None
    ...
    def closeEvent(self, event: PySide2.QtGui.QCloseEvent):
        ...
        super(USBVideoWindow, self).closeEvent(event)
    ...
    def _start_capture(self):
        ...
        if self.ui.rBtn_Thread.isChecked():
            # self.camera_reader = QtUSBCameraFrameReader()
            # self.camera_controller = QtCameraController(self.camera_reader)
            self.camera_reader = USBCameraFrameReader()
            ...
            self.video_capture = PickleUSBVideoCapture()
