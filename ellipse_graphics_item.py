...
import numpy as np
import PySide2
from PySide2.QtCore import (Qt, QPointF, qDebug, QRectF, QObject)
from PySide2.QtGui import (QImage, QPixmap, QPen, QBrush, QFont, qGray, QPainterPath)
from PySide2.QtWidgets import (QGraphicsScene, QGraphicsPixmapItem, QGraphicsPathItem,
...
# QGraphicsEllipseItemの派生クラス
class EllipseGraphicsItem(QGraphicsEllipseItem):

    def __init__(self, rect:QRectF, parent:QObject):
        super(EllipseGraphicsItem, self).__init__(rect, parent)
    ...
    def set_rect(self, rect: PySide2.QtCore.QRectF, mouse_pos: PySide2.QtCore.QPointF):
        ...
        super(EllipseGraphicsItem, self).setRect(rect)
    ...
    def contextMenuEvent(self, event: PySide2.QtWidgets.QGraphicsSceneContextMenuEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).contextMenuEvent(event)
    ...
    def mousePressEvent(self, event: PySide2.QtWidgets.QGraphicsSceneMouseEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).mousePressEvent(event)
    ...
    def mouseReleaseEvent(self, event: PySide2.QtWidgets.QGraphicsSceneMouseEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).mouseReleaseEvent(event)
    ...
    def mouseDoubleClickEvent(self, event: PySide2.QtWidgets.QGraphicsSceneMouseEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).mouseDoubleClickEvent(event)
    ...
    def mouseMoveEvent(self, event: PySide2.QtWidgets.QGraphicsSceneMouseEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).mouseMoveEvent(event)
    ...
    def dropEvent(self, event: PySide2.QtWidgets.QGraphicsSceneDragDropEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).dropEvent(event)
    ...
    def dragLeaveEvent(self, event: PySide2.QtWidgets.QGraphicsSceneDragDropEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).dragLeaveEvent(event)
    ...
    def dragMoveEvent(self, event: PySide2.QtWidgets.QGraphicsSceneDragDropEvent):
        ...
        :return:
        """
        super(EllipseGraphicsItem, self).dragMoveEvent(event)
    ...
    def itemChange(self, change: PySide2.QtWidgets.QGraphicsItem.GraphicsItemChange, value: Any) -> Any:
        ...
        :return:
        """
        return super(EllipseGraphicsItem, self).itemChange(change, value)