...
################################################################################
## Form generated from reading UI file 'ui_OMRONVideoWindow.ui'
##
...
class Ui_OMRONVideoWindow(object):
    def setupUi(self, OMRONVideoWindow):
        if OMRONVideoWindow.objectName():
            OMRONVideoWindow.setObjectName(u"OMRONVideoWindow")
        OMRONVideoWindow.resize(660, 437)
        self.centralwidget = QWidget(OMRONVideoWindow)
        ...
        OMRONVideoWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QStatusBar(OMRONVideoWindow)
        self.statusbar.setObjectName(u"statusbar")
        OMRONVideoWindow.setStatusBar(self.statusbar)
        self.dockWidget = QDockWidget(OMRONVideoWindow)
        ...
        OMRONVideoWindow.addDockWidget(Qt.RightDockWidgetArea, self.dockWidget)
        self.toolBar = QToolBar(OMRONVideoWindow)
        self.toolBar.setObjectName(u"toolBar")
        OMRONVideoWindow.addToolBar(Qt.TopToolBarArea, self.toolBar)

        self.retranslateUi(OMRONVideoWindow)

        QMetaObject.connectSlotsByName(OMRONVideoWindow)
    # setupUi

    def retranslateUi(self, OMRONVideoWindow):
        OMRONVideoWindow.setWindowTitle(QCoreApplication.translate("OMRONVideoWindow", u"OMRONVideoWindow", None))
        self.lEdit_Image_Status.setPlaceholderText(QCoreApplication.translate("OMRONVideoWindow", u"Image Status", None))
        self.lbl_Image_Scale.setText(QCoreApplication.translate("OMRONVideoWindow", u"100%", None))
        self.dockWidget.setWindowTitle(QCoreApplication.translate("OMRONVideoWindow", u"Inspector@OMRONVideoWindow", None))
        self.grp_Device.setTitle(QCoreApplication.translate("OMRONVideoWindow", u"Device", None))
        self.lbl_Device_List.setText(QCoreApplication.translate("OMRONVideoWindow", u"List of devices", None))
        self.pBtn_Search_Device_List.setText(QCoreApplication.translate("OMRONVideoWindow", u"Search", None))
        self.lbl_Device_ID.setText(QCoreApplication.translate("OMRONVideoWindow", u"Device ID", None))
        self.lEdit_Device_ID.setText(QCoreApplication.translate("OMRONVideoWindow", u"0", None))
        self.grp_Control.setTitle(QCoreApplication.translate("OMRONVideoWindow", u"Control", None))
        self.lbl_Read_Frame_Delay.setText(QCoreApplication.translate("OMRONVideoWindow", u"Read Frame Delay [ms]", None))
        self.lbl_Paint_Timer_Interval.setText(QCoreApplication.translate("OMRONVideoWindow", u"Paint Timer Interval [ms]", None))
        self.rBtn_Thread.setText(QCoreApplication.translate("OMRONVideoWindow", u"Thread", None))
        self.rBtn_Process.setText(QCoreApplication.translate("OMRONVideoWindow", u"Process", None))
        self.cBox_FPS.setText(QCoreApplication.translate("OMRONVideoWindow", u"FPS", None))
        self.cBox_Elapsed_Time.setText(QCoreApplication.translate("OMRONVideoWindow", u"Elapsed", None))
        self.cBox_Timestamp.setText(QCoreApplication.translate("OMRONVideoWindow", u"Stamp", None))
        self.pBtn_Start.setText(QCoreApplication.translate("OMRONVideoWindow", u"Start", None))
        self.pBtn_Stop.setText(QCoreApplication.translate("OMRONVideoWindow", u"Stop", None))
        self.pBtn_Snapshot.setText(QCoreApplication.translate("OMRONVideoWindow", u"Snapshot", None))
        self.lbl_Timer_ID.setText(QCoreApplication.translate("OMRONVideoWindow", u"Timer ID", None))
        self.lEdit_Timer_ID.setPlaceholderText(QCoreApplication.translate("OMRONVideoWindow", u"Timer ID", None))
        self.lbl_Timer_Type.setText(QCoreApplication.translate("OMRONVideoWindow", u"Timer Type", None))
#if QT_CONFIG(tooltip)
        self.lEdit_Timer_Type.setToolTip(QCoreApplication.translate("OMRONVideoWindow", u"Precision, Coarse(\u00b15%), VeryCoarse(sec)", None))
#endif // QT_CONFIG(tooltip)
        self.lEdit_Timer_Type.setPlaceholderText(QCoreApplication.translate("OMRONVideoWindow", u"Accuracy on platform", None))
        self.toolBar.setWindowTitle(QCoreApplication.translate("OMRONVideoWindow", u"toolBar", None))
    # retranslateUi
