...
################################################################################
## Form generated from reading UI file 'ui_USBVideoWindow.ui'
##
...
class Ui_USBVideoWindow(object):
    def setupUi(self, USBVideoWindow):
        if USBVideoWindow.objectName():
            USBVideoWindow.setObjectName(u"USBVideoWindow")
        USBVideoWindow.resize(660, 437)
        self.centralwidget = QWidget(USBVideoWindow)
        ...
        USBVideoWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QStatusBar(USBVideoWindow)
        self.statusbar.setObjectName(u"statusbar")
        USBVideoWindow.setStatusBar(self.statusbar)
        self.dockWidget = QDockWidget(USBVideoWindow)
        ...
        USBVideoWindow.addDockWidget(Qt.RightDockWidgetArea, self.dockWidget)
        self.toolBar = QToolBar(USBVideoWindow)
        self.toolBar.setObjectName(u"toolBar")
        USBVideoWindow.addToolBar(Qt.TopToolBarArea, self.toolBar)

        self.retranslateUi(USBVideoWindow)

        QMetaObject.connectSlotsByName(USBVideoWindow)
    # setupUi

    def retranslateUi(self, USBVideoWindow):
        USBVideoWindow.setWindowTitle(QCoreApplication.translate("USBVideoWindow", u"USBVideoWindow", None))
        self.lEdit_Image_Status.setPlaceholderText(QCoreApplication.translate("USBVideoWindow", u"Image Status", None))
        self.lbl_Image_Scale.setText(QCoreApplication.translate("USBVideoWindow", u"100%", None))
        self.dockWidget.setWindowTitle(QCoreApplication.translate("USBVideoWindow", u"Inspector", None))
        self.grp_Device.setTitle(QCoreApplication.translate("USBVideoWindow", u"Device", None))
        self.lbl_Device_List.setText(QCoreApplication.translate("USBVideoWindow", u"List of devices", None))
        self.pBtn_Search_Device_List.setText(QCoreApplication.translate("USBVideoWindow", u"Search", None))
        self.lbl_Device_ID.setText(QCoreApplication.translate("USBVideoWindow", u"Device ID", None))
        self.lEdit_Device_ID.setText(QCoreApplication.translate("USBVideoWindow", u"0", None))
        self.grp_Control.setTitle(QCoreApplication.translate("USBVideoWindow", u"Control", None))
        self.lbl_Read_Frame_Delay.setText(QCoreApplication.translate("USBVideoWindow", u"Read Frame Delay [ms]", None))
        self.lbl_Paint_Timer_Interval.setText(QCoreApplication.translate("USBVideoWindow", u"Paint Timer Interval [ms]", None))
        self.rBtn_Thread.setText(QCoreApplication.translate("USBVideoWindow", u"Thread", None))
        self.rBtn_Process.setText(QCoreApplication.translate("USBVideoWindow", u"Process", None))
        self.cBox_FPS.setText(QCoreApplication.translate("USBVideoWindow", u"FPS", None))
        self.cBox_Elapsed_Time.setText(QCoreApplication.translate("USBVideoWindow", u"Elapsed", None))
        self.cBox_Timestamp.setText(QCoreApplication.translate("USBVideoWindow", u"Stamp", None))
        self.pBtn_Start.setText(QCoreApplication.translate("USBVideoWindow", u"Start", None))
        self.pBtn_Stop.setText(QCoreApplication.translate("USBVideoWindow", u"Stop", None))
        self.pBtn_Snapshot.setText(QCoreApplication.translate("USBVideoWindow", u"Snapshot", None))
        self.lbl_Timer_ID.setText(QCoreApplication.translate("USBVideoWindow", u"Timer ID", None))
        self.lEdit_Timer_ID.setPlaceholderText(QCoreApplication.translate("USBVideoWindow", u"Timer ID", None))
        self.lbl_Timer_Type.setText(QCoreApplication.translate("USBVideoWindow", u"Timer Type", None))
#if QT_CONFIG(tooltip)
        self.lEdit_Timer_Type.setToolTip(QCoreApplication.translate("USBVideoWindow", u"Precision, Coarse(\u00b15%), VeryCoarse(sec)", None))
#endif // QT_CONFIG(tooltip)
        self.lEdit_Timer_Type.setPlaceholderText(QCoreApplication.translate("USBVideoWindow", u"Accuracy on platform", None))
        self.toolBar.setWindowTitle(QCoreApplication.translate("USBVideoWindow", u"toolBar", None))
    # retranslateUi
