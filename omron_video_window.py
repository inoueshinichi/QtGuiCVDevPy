"""OMRON Sentechカメラのフレームを制御及び表示するウィンドウ
"""
...
from ui.ui_OMRONVideoWindow import Ui_OMRONVideoWindow
...
class OMRONVideoWindow(ImageWindow):

    def __init__(self, parent:QWidget=None):
        super(OMRONVideoWindow, self).__init__(parent)

        # UI
        self.ui:Any = Ui_OMRONVideoWindow()
    ...
    def closeEvent(self, event: PySide2.QtGui.QCloseEvent):
        ...
        super(OMRONVideoWindow, self).closeEvent(event)
